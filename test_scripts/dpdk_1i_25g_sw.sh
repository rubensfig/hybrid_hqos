...
sudo $DPDK/x86_64-native-linuxapp-gcc/examples/dpdk-qos_sched -l35,36,37,38 -a b3:01.0 -n 8 -- --mnc 35 --cfg $DPDK/examples/qos_sched/profile_25gb_unlimited.cfg --pfc 0,0,36,37,38 --rsz 4096,32768,4096 --bsz 128,512,511,511 -i --msz 524288
